...
\todo{JDC: Cite SAMPL overview papers.}
...
\todo{JDC: Cite some SAMPL papers highlighting lessons learned.}
...
25~{\micro}L of mid-range buffer (14.7~mM \ce{K2HPO4} 0.15~M \ce{KCl} in \ce{H2O}) was added to each sample, transfered with a micropipette (Rainin EDP3 LTS 10-100 \micro L). to provide enough buffering capacity in middle pH ranges so that pH could be controlled incrementally throughout the titration.  
...
\todo[inline]{Add results of NMR analysis of SM07}
